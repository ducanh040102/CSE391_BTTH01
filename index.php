...
include('./views/admin/includes/headerAdmin.php');
//Routing: định tuyến
...
$controller = isset($_GET['controller']) ? $_GET['controller'] : 'indexAdmin';
$action     = isset($_GET['action']) ? $_GET['action'] : 'index';
// Bước 02: Tìm tệp mà mình sẽ chuyển lại Quyền cho nó (Controller)
//$controller = ucfirst($controller);
$controller .= 'Controller';
$controllerPath = 'controllers/' . $controller . '.php';
//$controllerPath = 'views/article/' . $controller . '.php';
//echo $controller;
//echo $controllerPath;
...
include('./views/admin/includes/footerAdmin.php');
